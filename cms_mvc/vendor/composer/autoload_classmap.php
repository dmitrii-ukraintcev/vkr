...
return array(
    ...
    'EmailTest' => $baseDir . '/src/EmailTest.php',
    ...
    'modules\\category\\admin\\controllers\\CategoryController' => $baseDir . '/modules/category/admin/controllers/CategoryController.php',
    'modules\\category\\models\\Category' => $baseDir . '/modules/category/models/Category.php',
    'modules\\category\\models\\CategoryData' => $baseDir . '/modules/category/models/CategoryData.php',
    'modules\\dashboard\\admin\\controllers\\DashboardController' => $baseDir . '/modules/dashboard/admin/controllers/DashboardController.php',
    'modules\\menu\\admin\\controllers\\MenuController' => $baseDir . '/modules/menu/admin/controllers/MenuController.php',
    'modules\\menu\\admin\\models\\Menu' => $baseDir . '/modules/menu/admin/models/Menu.php',
    'modules\\menu\\admin\\models\\MenuItem' => $baseDir . '/modules/menu/admin/models/MenuItem.php',
    'modules\\menu\\admin\\models\\MenuItemData' => $baseDir . '/modules/menu/admin/models/MenuItemData.php',
    'modules\\page\\admin\\controllers\\PageController' => $baseDir . '/modules/page/admin/controllers/PageController.php',
    ...
    'modules\\page\\models\\PageData' => $baseDir . '/modules/page/models/PageData.php',
    'modules\\post\\admin\\controllers\\PostController' => $baseDir . '/modules/post/admin/controllers/PostController.php',
    ...
    'modules\\post\\models\\PostCategories' => $baseDir . '/modules/post/models/PostCategories.php',
    'modules\\post\\models\\PostData' => $baseDir . '/modules/post/models/PostData.php',
    'modules\\theme\\admin\\controllers\\ThemeController' => $baseDir . '/modules/theme/admin/controllers/ThemeController.php',
    'modules\\theme\\admin\\models\\Theme' => $baseDir . '/modules/theme/admin/models/Theme.php',
    'modules\\user\\admin\\controllers\\UserController' => $baseDir . '/modules/user/admin/controllers/UserController.php',
    'modules\\user\\admin\\models\\User' => $baseDir . '/modules/user/admin/models/User.php',
    'src\\AdminController' => $baseDir . '/src/AdminController.php',
    'src\\Auth' => $baseDir . '/src/Auth.php',
    'src\\ContentEntity' => $baseDir . '/src/ContentEntity.php',
    'src\\Controller' => $baseDir . '/src/Controller.php',
    'src\\DatabaseConnection' => $baseDir . '/src/DatabaseConnection.php',
    'src\\Email' => $baseDir . '/src/Email.php',
    'src\\Entity' => $baseDir . '/src/Entity.php',
    'src\\EntityController' => $baseDir . '/src/EntityController.php',
    'src\\Route' => $baseDir . '/src/Route.php',
    'src\\RouteData' => $baseDir . '/src/RouteData.php',
    'src\\Template' => $baseDir . '/src/Template.php',
