...
class ComposerStaticInita50aa7a4aac6a4ff483de5f21554c3ee
{
    ...
    public static $classMap = array (
        ...
        'EmailTest' => __DIR__ . '/../..' . '/src/EmailTest.php',
        ...
        'modules\\category\\admin\\controllers\\CategoryController' => __DIR__ . '/../..' . '/modules/category/admin/controllers/CategoryController.php',
        'modules\\category\\models\\Category' => __DIR__ . '/../..' . '/modules/category/models/Category.php',
        'modules\\category\\models\\CategoryData' => __DIR__ . '/../..' . '/modules/category/models/CategoryData.php',
        'modules\\dashboard\\admin\\controllers\\DashboardController' => __DIR__ . '/../..' . '/modules/dashboard/admin/controllers/DashboardController.php',
        'modules\\menu\\admin\\controllers\\MenuController' => __DIR__ . '/../..' . '/modules/menu/admin/controllers/MenuController.php',
        'modules\\menu\\admin\\models\\Menu' => __DIR__ . '/../..' . '/modules/menu/admin/models/Menu.php',
        'modules\\menu\\admin\\models\\MenuItem' => __DIR__ . '/../..' . '/modules/menu/admin/models/MenuItem.php',
        'modules\\menu\\admin\\models\\MenuItemData' => __DIR__ . '/../..' . '/modules/menu/admin/models/MenuItemData.php',
        'modules\\page\\admin\\controllers\\PageController' => __DIR__ . '/../..' . '/modules/page/admin/controllers/PageController.php',
        ...
        'modules\\page\\models\\PageData' => __DIR__ . '/../..' . '/modules/page/models/PageData.php',
        'modules\\post\\admin\\controllers\\PostController' => __DIR__ . '/../..' . '/modules/post/admin/controllers/PostController.php',
        'modules\\post\\controllers\\PostController' => __DIR__ . '/../..' . '/modules/post/controllers/PostController.php',
        'modules\\post\\models\\Post' => __DIR__ . '/../..' . '/modules/post/models/Post.php',
        'modules\\post\\models\\PostCategories' => __DIR__ . '/../..' . '/modules/post/models/PostCategories.php',
        'modules\\post\\models\\PostData' => __DIR__ . '/../..' . '/modules/post/models/PostData.php',
        'modules\\theme\\admin\\controllers\\ThemeController' => __DIR__ . '/../..' . '/modules/theme/admin/controllers/ThemeController.php',
        'modules\\theme\\admin\\models\\Theme' => __DIR__ . '/../..' . '/modules/theme/admin/models/Theme.php',
        'modules\\user\\admin\\controllers\\UserController' => __DIR__ . '/../..' . '/modules/user/admin/controllers/UserController.php',
        'modules\\user\\admin\\models\\User' => __DIR__ . '/../..' . '/modules/user/admin/models/User.php',
        'src\\AdminController' => __DIR__ . '/../..' . '/src/AdminController.php',
        'src\\Auth' => __DIR__ . '/../..' . '/src/Auth.php',
        'src\\ContentEntity' => __DIR__ . '/../..' . '/src/ContentEntity.php',
        'src\\Controller' => __DIR__ . '/../..' . '/src/Controller.php',
        'src\\DatabaseConnection' => __DIR__ . '/../..' . '/src/DatabaseConnection.php',
        'src\\Email' => __DIR__ . '/../..' . '/src/Email.php',
        'src\\Entity' => __DIR__ . '/../..' . '/src/Entity.php',
        'src\\EntityController' => __DIR__ . '/../..' . '/src/EntityController.php',
        'src\\Route' => __DIR__ . '/../..' . '/src/Route.php',
        'src\\RouteData' => __DIR__ . '/../..' . '/src/RouteData.php',
        'src\\Template' => __DIR__ . '/../..' . '/src/Template.php',
